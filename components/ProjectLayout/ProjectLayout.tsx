...
export const ProjectLayout = ({ name, description, date, demoLink }) => {
  return (
    <Link href={demoLink} target="_blank" className=" text-sm md:text-base flex cursor-pointer items-center justify-between w-full relative rounded-lg overflow-hidden p-4 md:p-6  text-foreground group custom-bg ">
