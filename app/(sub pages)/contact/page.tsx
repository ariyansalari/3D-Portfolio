...
export default function Projects() {
  return (
    ...
    <article className="relative w-full flex flex-col items-center justify-center space-x-8">
<div className="flex flex-col items-center justify-center space-y-6 w-3/4 mb-8 ">
